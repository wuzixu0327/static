                            ...
                            <tbody>
                                <template v-for="data in tableData" :key="data.id">
                                    <tr>
                                        ...
                                        <td>{{ data.date }}</td>
                                        <td>{{ data.sale }}</td>
                                        <td class="whitespace-nowrap text-center" :class="{
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex h-1.5 w-full rounded-full bg-[#ebedf2] dark:bg-dark/40">
                                                <div class="h-1.5 rounded-full rounded-bl-full text-center text-xs text-white" :class="{
                                            ...
                                            <div class="dropdown">
                                                <client-only>
                                                    <Popper :placement="store.rtlClass === 'rtl' ? 'bottom-start' : 'bottom-end'" offsetDistance="0" class="align-middle">
                                                        <a href="javascript:;">
                                                            <icon-horizontal-dots class="m-auto opacity-70" />
                                                        </a>
                                                ...
                                                <li>
                                                    <client-only>
                                                        <a href="javascript:;" v-tippy:edit>
                                                            <icon-circle-check class="w-5 h-5 text-primary" />
                                                        </a>
                                                        <tippy target="edit">Edit</tippy>
                                                    </client-only>
                                                </li>
                                                <li>
                                                    <client-only>
                                                        <a href="javascript:;" v-tippy:delete>
                                                            <icon-x-circle class="text-danger" />
                                                        </a>
                                                        <tippy target="delete">Delete</tippy>
                                                    </client-only>
                                                </li>
