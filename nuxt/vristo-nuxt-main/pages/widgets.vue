    ...
    <div>
        <div class="mb-6 grid gap-6 xl:grid-cols-3">
            ...
            <div class="panel h-full">
                ...
                <div>
                    <client-only>
                        <apexchart height="460" :options="salesByCategory" :series="salesByCategorySeries" class="overflow-hidden rounded-lg bg-white dark:bg-black">
                            <!-- loader -->
            ...
            <div class="panel h-full pb-0 sm:col-span-2 xl:col-span-1">
                ...
                <div class="border-t border-white-light dark:border-white/10">
                    <a href="javascript:;" class="group group flex items-center justify-center p-4 font-semibold hover:text-primary">
                        View All
                        <icon-arrow-left class="transition duration-300 group-hover:translate-x-1 ltr:ml-1 rtl:mr-1 rtl:rotate-180 rtl:group-hover:-translate-x-1" />
                    </a>
                </div>
            </div>
                ...
                <div class="min-h-[190px] bg-gradient-to-r from-[#4361ee] to-[#160f6b] p-6">
                    <div class="mb-6 flex items-center justify-between">
                        <div class="flex items-center rounded-full bg-black/50 p-1 font-semibold text-white ltr:pr-3 rtl:pl-3">
                            <img class="block h-8 w-8 rounded-full border-2 border-white/50 object-cover ltr:mr-1 rtl:ml-1" src="/assets/images/profile-34.jpeg" alt="" />
                            Alan Green
                        </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr class="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                ...
                                <td>
                                    <NuxtLink to="/apps/invoice/preview">#46894</NuxtLink>
                                </td>
                                <td>$56.07</td>
                            ...
                            <tr class="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                ...
                                <td>
                                    <NuxtLink to="/apps/invoice/preview">#76894</NuxtLink>
                                </td>
                                <td>$126.04</td>
                            ...
                            <tr class="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                ...
                                <td>
                                    <NuxtLink to="/apps/invoice/preview">#66894</NuxtLink>
                                </td>
                                <td>$56.07</td>
                                <td><span class="badge bg-success shadow-md dark:group-hover:bg-transparent">Paid</span></td>
                            </tr>
                            <tr class="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                ...
                                <td>
                                    <NuxtLink to="/apps/invoice/preview">#75844</NuxtLink>
                                </td>
                                <td>$110.00</td>
                                <td><span class="badge bg-secondary shadow-md dark:group-hover:bg-transparent">Shipped</span></td>
                            </tr>
        ...
        <div class="mb-6 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="panel grid h-full grid-cols-1 content-between overflow-hidden before:absolute before:-right-44 before:bottom-0 before:top-0 before:m-auto before:h-96 before:w-96 before:rounded-full before:bg-[#1937cc]" style="background: linear-gradient(0deg, #00c6fb -227%, #005bea) !important">
            ...
            <div class="panel h-full">
                ...
                <client-only>
                    <perfect-scrollbar :options="{
                        ...
                        <div class="space-y-7">
                            <div class="flex">
                                <div class="relative z-10 shrink-0 before:absolute before:left-4 before:top-10 before:h-[calc(100%-24px)] before:w-[2px] before:bg-white-dark/30 ltr:mr-2 rtl:ml-2">
            ...
            <div class="panel h-full">
                ...
                <div class="pb-8 text-center font-semibold">
                    ...
                    <div class="flex items-center justify-center gap-3 pb-8">
                        <img class="h-10 w-10 overflow-hidden rounded-lg object-cover ring-2 ring-white-light dark:ring-dark" src="/assets/images/profile-1.jpeg" alt="" />
                        <img class="h-10 w-10 overflow-hidden rounded-lg object-cover ring-2 ring-white-light dark:ring-dark" src="/assets/images/profile-2.jpeg" alt="" />
                        <img class="h-10 w-10 overflow-hidden rounded-lg object-cover ring-2 ring-white-light dark:ring-dark" src="/assets/images/profile-3.jpeg" alt="" />
                        <img class="h-10 w-10 overflow-hidden rounded-lg object-cover ring-2 ring-white-light dark:ring-dark" src="/assets/images/profile-4.jpeg" alt="" />
                    </div>
                ...
                <div class="group">
                    ...
                    <div class="flex items-end justify-between">
                        ...
                        <div class="flex items-center justify-center group-hover:-space-x-2 rtl:space-x-reverse rtl:group-hover:space-x-reverse">
                            ...
                            <img class="h-9 w-9 rounded-full border-2 border-white object-cover transition-all duration-300 dark:border-dark" src="/assets/images/profile-6.jpeg" alt="" />
                            <img class="h-9 w-9 rounded-full border-2 border-white object-cover transition-all duration-300 dark:border-dark" src="/assets/images/profile-7.jpeg" alt="" />
                            <img class="h-9 w-9 rounded-full border-2 border-white object-cover transition-all duration-300 dark:border-dark" src="/assets/images/profile-8.jpeg" alt="" />
                        </div>
                    </div>
                </div>
            </div>
