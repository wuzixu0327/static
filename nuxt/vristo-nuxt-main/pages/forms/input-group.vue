                        ...
                        <form>
                            <div class="flex">
                                ...
                                <input
                                    ...
                                    class="form-input flex-1 rounded-none focus:!border-l focus:!border-r ltr:border-r-0 rtl:border-l-0"
                                />
                            ...
                            <div>
                                <div class="flex">
                                    <input
                                        type="text"
                                        placeholder=""
                                        class="form-input flex-1 ltr:rounded-l-md ltr:rounded-r-none rtl:rounded-l-none rtl:rounded-r-md"
                                    />
                                    <div
