        ...
        <div class="grid grid-cols-1 gap-6 pt-5 xl:grid-cols-2">
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    ...
                    <div class="sm:flex">
                        <div
                            class="relative z-[2] mx-auto mb-5 before:absolute before:-bottom-[15px] before:left-1/2 before:top-12 before:-z-[1] before:hidden before:h-auto before:w-0 before:-translate-x-1/2 before:border-l-2 before:border-[#ebedf2] dark:before:border-[#191e3a] sm:mb-0 sm:before:block ltr:sm:mr-8 rtl:sm:ml-8"
                        >
                ...
                <div class="mb-5">
                    <div class="mx-auto max-w-[900px] space-y-3 text-center sm:space-y-0 ltr:sm:text-left rtl:sm:text-right">
                        <div class="items-center sm:flex">
                            ...
                            <div
                                class="relative p-2.5 after:absolute after:-bottom-[15px] after:left-1/2 after:top-[25px] after:h-auto after:w-0 after:-translate-x-1/2 after:rounded-full after:border-l-2 after:border-white-dark/20"
                            >
