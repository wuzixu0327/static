...
return static function (RouteBuilder $routes) {
    ...
    $routes->connect('/pages/contact-us-boxed', 'Pages::pages_contact_us_boxed');
    $routes->connect('/pages/contact-us-cover', 'Pages::pages_contact_us_cover');
    $routes->connect('/pages/faq', 'Pages::pages_faq');
    $routes->connect('/pages/coming-soon-boxed', 'Pages::pages_coming_soon_boxed');
    $routes->connect('/pages/coming-soon-cover', 'Pages::pages_coming_soon_cover');
