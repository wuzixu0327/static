                    ...
                    <div class="flex-1">
                        ...
                        <div class="mt-4 sm:mt-7 mb-16">
                            ...
                            <div class="ltr:pl-8 rtl:pr-8 grid grid-cols-3 sm:grid-cols-5 lg:grid-cols-8 gap-3 mt-6">
                                ...
                                <img src="/assets/images/profile-16.jpeg" alt="image" class="w-full rounded-md shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none" />
