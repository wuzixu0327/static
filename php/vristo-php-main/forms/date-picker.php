...
&lt;/script&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-2.5">Use <code class="text-danger">{noCalendar: true, enableTime: true, dateFormat: 'H:i'}</code> with Date Time options to disable calendar and show time picker only.</div>
                <div class="mb-5">
