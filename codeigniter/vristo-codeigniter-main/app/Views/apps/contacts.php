                                ...
                                <td>
                                    <div class="flex items-center w-max">
                                        <div x-show="contact.path" class="w-max">
                                            <img :src="`<?php echo base_url('assets/images') ?>/${contact.path}`" class="h-8 w-8 rounded-full object-cover ltr:mr-2 rtl:ml-2" alt="avatar" />
                                        </div>
                ...
                <div class="bg-white dark:bg-[#1c232f] rounded-md overflow-hidden text-center shadow relative">
                    <div class="bg-white/40 rounded-t-md bg-[url('/assets/images/notification-bg.png')] bg-center bg-cover p-6 pb-0">
                        <template x-if="contact.path">
                            <img class="object-contain w-4/5 max-h-40 mx-auto" :src="`<?php echo base_url('assets/images') ?>/${contact.path}`" />
                        </template>
                    </div>
