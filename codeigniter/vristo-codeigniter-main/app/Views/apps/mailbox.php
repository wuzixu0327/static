                ...
                <div class="perfect-scrollbar relative pr-3.5 -mr-3.5 h-full grow">
                    <div class="space-y-1">
                        ...
                        <button type="button" class="w-full flex justify-between items-center p-2 hover:bg-white-dark/10 rounded-md dark:hover:text-primary hover:text-primary dark:hover:bg-[#181F32] font-medium h-10" :class="{
                            ...
                            <div class="bg-primary-light dark:bg-[#060818] rounded-md py-0.5 px-2 font-semibold whitespace-nowrap" x-text="mailList && mailList.filter((d) => !d.type || d.type === 'draft').length">
                            </div>
                        </button>
                        ...
                        <div x-data="dropdown" @click.outside="open = false">
                            ...
                            <ul x-cloak x-show="open" class="mt-1 space-y-1">
                                <li>
                                    <button type="button" class="w-full flex items-center p-2 hover:bg-white-dark/10 rounded-md dark:hover:text-primary hover:text-primary dark:hover:bg-[#181F32] font-medium h-10" :class="{
        ...
        <div class="panel p-0 flex-1 overflow-auto h-full">
                ...
                <div class="flex flex-wrap flex-col md:flex-row xl:w-auto justify-between items-center px-4 pb-4">
                    ...
                    <div class="mt-4 md:flex-auto flex-1">
                        <div class="flex items-center md:justify-end justify-center">
                            <div class="ltr:mr-3 rtl:ml-3" x-text="pager.startIndex+1 + '-' +( pager.endIndex+1) + ' of ' + filteredMailList.length">
                            </div>
                    ...
                    <div class="p-4 relative">
                        <div class="flex flex-wrap">
                            <div class="flex-shrink-0 ltr:mr-2 rtl:ml-2">
                                <img x-show="selectedMail.path" :src="`<?php echo base_url('assets/images') ?>/${selectedMail.path}`" class="h-12 w-12 rounded-full object-cover" alt="avatar" />
                            ...
                            <div class="ltr:mr-2 rtl:ml-2 flex-1">
                                <div class="flex items-center">
                                    <div class="text-lg ltr:mr-4 rtl:ml-4 whitespace-nowrap" x-text="selectedMail.firstName ? selectedMail.firstName + ' ' + selectedMail.lastName : selectedMail.email">
                                    </div>
                                ...
                                <div class="text-white-dark  flex items-center">
                                    <div class="ltr:mr-1 rtl:ml-1" x-text="selectedMail.type === 'sent_mail' ? selectedMail.email : 'to me'">
                                    </div>
                                    <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                                        ...
                                        <ul x-cloak x-show="open" x-transition x-transition.duration.300ms class="ltr:left-0 rtl:right-0 sm:w-56">
                                            <li>
                                                <div class="flex items-center px-4 py-2">
                                                    ...
                                                    <div class="flex-1" x-text="selectedMail.type === 'sent_mail' ? 'tailly@gmail.com' : selectedMail.email">
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <div class="flex items-center px-4 py-2">
                                                    ...
                                                    <div class="flex-1" x-text="selectedMail.date + ', ' + selectedMail.time">
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                            ...
                            <div class="flex items-center flex-wrap mt-6">
                                <template x-for="attachment in selectedMail.attachments">
                                    <button type="button" class=" flex items-center ltr:mr-4 rtl:ml-4 mb-4 border border-[#e0e6ed] dark:border-[#1b2e4b] rounded-md hover:text-primary hover:border-primary transition-all duration-300 px-4 py-2.5 relative group">
                                        ...
                                        <div class="bg-dark-light/40 z-[5] w-full h-full absolute ltr:left-0 rtl:right-0 top-0 rounded-md hidden group-hover:block">
                                        </div>
            ...
            <template x-if="isEdit">
                <div class="relative">
                    ...
                    <div class="h-px bg-gradient-to-l from-indigo-900/20 via-black dark:via-white to-indigo-900/20 opacity-[0.1]">
                    </div>
        ...
        Alpine.data("mailbox", () => ({
            ...
            mailList: [{
                    ...
                    description: `
                            ...
                            <img alt="image-gallery" src="<?php echo base_url('assets/images/carousel3.jpeg') ?>" class="mb-4 mt-4" style="width: 250px; height: 180px;" />
                            <img alt="image-gallery" src="<?php echo base_url('assets/images/carousel2.jpeg') ?>" class="mb-4 mt-4" style="width: 250px; height: 180px;" />
                            <img alt="image-gallery" src="<?php echo base_url('assets/images/carousel1.jpeg') ?>" class="mb-4 mt-4" style="width: 250px; height: 180px;" />
                            </div>
