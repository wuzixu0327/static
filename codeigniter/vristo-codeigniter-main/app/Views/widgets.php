...
<div x-data="chart">
            ...
            <div class="p-6 bg-gradient-to-r from-[#4361ee] to-[#160f6b] min-h-[190px]">
                <div class="flex justify-between items-center mb-6">
                    <div class="bg-black/50 rounded-full p-1 ltr:pr-3 rtl:pl-3 flex items-center text-white font-semibold">
                        <img class="w-8 h-8 rounded-full border-2 border-white/50 block object-cover ltr:mr-1 rtl:ml-1" src="<?php echo base_url('assets/images/profile-34.jpeg') ?>" alt="image" />
                        Alan Green
                    </div>
                    ...
                    <tbody>
                        <tr class="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                            <td class="min-w-[150px] text-black dark:text-white">
                                <div class="flex items-center">
                                    <img class="w-8 h-8 rounded-md ltr:mr-3 rtl:ml-3 object-cover" src="<?php echo base_url('assets/images/profile-6.jpeg') ?>" alt="avatar" />
                        ...
                        <tr class="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                            <td class="text-black dark:text-white">
                                <div class="flex items-center">
                                    <img class="w-8 h-8 rounded-md ltr:mr-3 rtl:ml-3 object-cover" src="<?php echo base_url('assets/images/profile-7.jpeg') ?>" alt="avatar" />
                        ...
                        <tr class="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                            <td class="text-black dark:text-white">
                                <div class="flex items-center">
                                    <img class="w-8 h-8 rounded-md ltr:mr-3 rtl:ml-3 object-cover" src="<?php echo base_url('assets/images/profile-8.jpeg') ?>" alt="avatar" />
                        ...
                        <tr class="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                            <td class="text-black dark:text-white">
                                <div class="flex items-center">
                                    <img class="w-8 h-8 rounded-md ltr:mr-3 rtl:ml-3 object-cover" src="<?php echo base_url('assets/images/profile-9.jpeg') ?>" alt="avatar" />
                        ...
                        <tr class="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                            <td class="text-black dark:text-white">
                                <div class="flex items-center">
                                    <img class="w-8 h-8 rounded-md ltr:mr-3 rtl:ml-3 object-cover" src="<?php echo base_url('assets/images/profile-10.jpeg') ?>" alt="avatar" />
            ...
            <div class="table-responsive">
                <table>
                    ...
                    <tbody>
                        <tr class="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                            <td class="min-w-[150px] text-black dark:text-white">
                                <div class="flex"><img class="w-8 h-8 rounded-md ltr:mr-3 rtl:ml-3 object-cover" src="<?php echo base_url('assets/images/product-headphones.jpg') ?>" alt="avatar" />
                        ...
                        <tr class="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                            <td class="text-black dark:text-white">
                                <div class="flex"><img class="w-8 h-8 rounded-md ltr:mr-3 rtl:ml-3 object-cover" src="<?php echo base_url('assets/images/product-shoes.jpg') ?>" alt="avatar" />
                        ...
                        <tr class="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                            <td class="text-black dark:text-white">
                                <div class="flex"><img class="w-8 h-8 rounded-md ltr:mr-3 rtl:ml-3 object-cover" src="<?php echo base_url('assets/images/product-watch.jpg') ?>" alt="avatar" />
                        ...
                        <tr class="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                            <td class="text-black dark:text-white">
                                <div class="flex"><img class="w-8 h-8 rounded-md ltr:mr-3 rtl:ml-3 object-cover" src="<?php echo base_url('assets/images/product-laptop.jpg') ?>" alt="avatar" />
                        ...
                        <tr class="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                            <td class="text-black dark:text-white">
                                <div class="flex"><img class="w-8 h-8 rounded-md ltr:mr-3 rtl:ml-3 object-cover" src="<?php echo base_url('assets/images/product-camera.jpg') ?>" alt="avatar" />
    ...
    <div class="grid lg:grid-cols-3 gap-6 mb-6">
        ...
        <div class="panel h-full">
            ...
            <div class="perfect-scrollbar relative h-[360px] pr-3 -mr-3">
                <div class="space-y-7">
                    <div class="flex">
                        <div class="shrink-0 ltr:mr-2 rtl:ml-2 relative z-10 before:w-[2px] before:h-[calc(100%-24px)] before:bg-white-dark/30 before:absolute before:top-10 before:left-4">
    ...
    <div class="grid sm:grid-cols-3 xl:grid-cols-5 gap-6 mb-6">
        ...
        <div class="panel h-full p-0">
            <div class="flex p-5">
                <div class="shrink-0 bg-success/10 text-success rounded-xl w-11 h-11 flex justify-center items-center dark:bg-success dark:text-white-light">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5">
        ...
        <div class="panel h-full">
            <div class="flex items-start border-b  border-[#e0e6ed] dark:border-[#1b2e4b] -m-5 mb-5 p-5">
                <div class="shrink-0 ring-2 ring-white-light dark:ring-dark rounded-full ltr:mr-4 rtl:ml-4">
                    <img src="<?php echo base_url('assets/images/profile-1.jpeg') ?>" alt="image" class="w-10 h-10 rounded-full object-cover" />
                </div>
        ...
        <div class="panel h-full">
            <div class="flex items-center justify-between border-b  border-[#e0e6ed] dark:border-[#1b2e4b] -m-5 mb-5 p-5">
                <div class="flex">
                    <div class="media-aside align-self-start">
                        <div class="shrink-0 ring-2 ring-white-light dark:ring-dark rounded-full ltr:mr-4 rtl:ml-4">
                            <img src="<?php echo base_url('assets/images/g-8.png') ?>" alt="image" class="w-10 h-10 rounded-full object-cover" />
                        </div>
                    </div>
                    <div class="font-semibold">
            ...
            <div class="font-semibold text-center pb-8">
                ...
                <div class="flex items-center justify-center gap-3 pb-8">
                    <img class="w-10 h-10 ring-2 ring-white-light dark:ring-dark rounded-lg overflow-hidden object-cover" src="<?php echo base_url('assets/images/profile-1.jpeg') ?>" alt="image" />
                    <img class="w-10 h-10 ring-2 ring-white-light dark:ring-dark rounded-lg overflow-hidden object-cover" src="<?php echo base_url('assets/images/profile-2.jpeg') ?>" alt="image" />
                    <img class="w-10 h-10 ring-2 ring-white-light dark:ring-dark rounded-lg overflow-hidden object-cover" src="<?php echo base_url('assets/images/profile-3.jpeg') ?>" alt="image" />
                    <img class="w-10 h-10 ring-2 ring-white-light dark:ring-dark rounded-lg overflow-hidden object-cover" src="<?php echo base_url('assets/images/profile-4.jpeg') ?>" alt="image" />
                </div>
            ...
            <div class="group">
                ...
                <div class="flex items-end justify-between">
                    ...
                    <div class="flex items-center justify-center group-hover:-space-x-2 rtl:space-x-reverse rtl:group-hover:space-x-reverse">
                        ...
                        <img class="w-9 h-9 border-2 border-white dark:border-dark rounded-full object-cover transition-all duration-300" src="<?php echo base_url('assets/images/profile-6.jpeg') ?>" alt="image" />
                        <img class="w-9 h-9 border-2 border-white dark:border-dark rounded-full object-cover transition-all duration-300" src="<?php echo base_url('assets/images/profile-7.jpeg') ?>" alt="image" />
                        <img class="w-9 h-9 border-2 border-white dark:border-dark rounded-full object-cover transition-all duration-300" src="<?php echo base_url('assets/images/profile-8.jpeg') ?>" alt="image" />
                    </div>
                </div>
            </div>
        </div>
