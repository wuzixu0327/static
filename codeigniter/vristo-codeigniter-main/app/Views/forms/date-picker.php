...
<div>
    ...
    <div class="pt-5 space-y-8" x-data="form">
        ...
        <div class="panel p-3 flex items-center text-primary overflow-x-auto whitespace-nowrap">
            ...
            <span class="ltr:mr-3 rtl:ml-3">Documentation: </span><a href="https://www.npmjs.com/package/flatpickr" target="_blank" class="block hover:underline">https://www.npmjs.com/package/flatpickr</a>
        </div>
    ...
    &lt;/script&gt;
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <div class="font-bold"> <span x-text="slider1" class="inline-block py-1 px-2 rounded text-primary border border-white-light dark:border-dark"></span>
                        <span>%</span>
                    </div>
    ...
    &lt;/script&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <div class="font-bold ltr:text-right rtl:text-left"> <span x-text="slider2" class="inline-block py-1 px-2 rounded text-primary border border-white-light dark:border-dark"></span>
                        <span>%</span>
                    </div>
    ...
    &lt;/script&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    ...
                    <div class="font-bold"> <span x-text="slider3" class="inline-block py-1 px-2 rounded text-primary border border-white-light dark:border-dark"></span>
                        <span>%</span>
                    </div>
                </div>
    ...
    &lt;/script&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    ...
                    <div class="font-bold ltr:text-right rtl:text-left"> <span x-text="slider4" class="inline-block py-1 px-2 rounded text-primary border border-white-light dark:border-dark"></span>
                        <span>%</span>
                    </div>
                </div>
    ...
    &lt;/script&gt;
        ...
        <div class="panel p-3 flex items-center text-primary overflow-x-auto whitespace-nowrap">
            ...
            <span class="ltr:mr-3 rtl:ml-3">Documentation: </span><a href="https://www.npmjs.com/package/nouislider" target="_blank" class="block hover:underline">https://www.npmjs.com/package/nouislider</a>
        </div>
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    &lt;/script&gt;
            ...
            <div class="panel lg:col-span-2">
                ...
                <div class="mb-5 pt-5">
                    ...
                    <div class="ltr:text-right rtl:text-left">
                        <button type="button" class="btn btn-primary" id="lockbutton" @click="lockedState = !lockedState" x-text="lockedState ? 'Unlock':'Lock'"> Lock
                        </button>
                    </div>
                </div>
