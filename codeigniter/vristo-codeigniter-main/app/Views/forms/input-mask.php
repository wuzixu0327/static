...
<script src="<?php echo base_url('assets/js/alpine-mask.min.js') ?>"></script>
...
<div x-data="form">
    ...
    <div class="pt-5 space-y-8">
        <div class="panel p-3 flex items-center text-primary overflow-x-auto whitespace-nowrap">
            ...
            <span class="ltr:mr-3 rtl:ml-3">Documentation: </span><a href="https://alpinejs.dev/plugins/mask" target="_blank" class="block hover:underline">https://alpinejs.dev/plugins/mask</a>
        </div>
                    ...
                    <form>
                        <fieldset class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input id="altnMask1" type="text" placeholder="__._" class="form-input" x-mask="99.9" />
                            </div>
                            <div>
                                <label for="altnMask2" class="text-white-dark">x-mask="'##.##'" (99.99)</label>
                                <input id="altnMask2" type="text" placeholder="__.__" class="form-input" x-mask="99.99" />
                            </div>
                        </fieldset>
                    </form>
                </div>
