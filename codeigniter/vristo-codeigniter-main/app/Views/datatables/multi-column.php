                ...
                this.datatable = new simpleDatatables.DataTable('#myTable', {
                    ...
                    columns: [{
                            ...
                            render: (data, cell, row) => {
                                return `<div class="flex items-center w-max"><img class="w-9 h-9 rounded-full ltr:mr-2 rtl:ml-2 object-cover" src="<?php echo base_url('assets/images/profile') ?>-${row.dataIndex + 1}.jpeg" />${data}</div>`;
                            },
                            sort: "asc"
                        },
                        {
