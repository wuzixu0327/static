    ...
    <div class="pt-5">
        ...
        <div class="grid sm:grid-cols-3 xl:grid-cols-5 gap-6 mb-6">
            ...
            <div class="panel h-full p-0">
                ...
                <div class="h-40">
                    <div x-ref="followers" class="w-full absolute bottom-0 overflow-hidden"></div>
                </div>
            </div>
            ...
            <div class="panel h-full p-0">
                ...
                <div class="h-40">
                    <div x-ref="referral" class="w-full absolute bottom-0 overflow-hidden"></div>
                </div>
            </div>
            ...
            <div class="panel h-full p-0">
                ...
                <div class="h-40">
                    <div x-ref="engagement" class="w-full absolute bottom-0 overflow-hidden"></div>
                </div>
            </div>
        </div>
