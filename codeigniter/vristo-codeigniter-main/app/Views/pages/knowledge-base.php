...
<div x-data="knowledge">
        ...
        <div class="absolute bottom-20 end-5 hidden text-[#DBE7FF] rtl:rotate-y-180 dark:text-[#1B2E4B] md:block xl:bottom-14 xl:end-10">
            <svg width="375" height="185" viewBox="0 0 375 185" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-72 max-w-xs xl:w-full">
                <g clip-path="url(#clip0_1109_89938)">
                    ...
                    <path d="M311.651 143.838H188.007C187.818 143.837 187.637 143.762 187.503 143.629C187.37 143.495 187.294 143.314 187.294 143.126C187.294 142.937 187.37 142.756 187.503 142.623C187.637 142.489 187.818 142.414 188.007 142.414H311.651C311.841 142.414 312.023 142.489 312.157 142.622C312.291 142.756 312.366 142.937 312.366 143.126C312.366 143.314 312.291 143.496 312.157 143.629C312.023 143.763 311.841 143.838 311.651 143.838Z" fill="currentColor" />
                    <path d="M311.651 148.466H188.007C187.818 148.466 187.636 148.391 187.502 148.258C187.368 148.124 187.292 147.943 187.292 147.754C187.292 147.565 187.368 147.384 187.502 147.251C187.636 147.117 187.818 147.042 188.007 147.042H311.651C311.841 147.042 312.022 147.117 312.156 147.251C312.291 147.384 312.366 147.565 312.366 147.754C312.366 147.943 312.291 148.124 312.156 148.258C312.022 148.391 311.841 148.466 311.651 148.466Z" fill="currentColor" />
                    <path d="M311.651 153.095H188.007C187.818 153.095 187.637 153.019 187.503 152.886C187.37 152.752 187.294 152.572 187.294 152.383C187.294 152.194 187.37 152.014 187.503 151.88C187.637 151.747 187.818 151.671 188.007 151.671H311.651C311.745 151.671 311.838 151.689 311.925 151.725C312.012 151.76 312.091 151.813 312.158 151.879C312.224 151.945 312.277 152.024 312.313 152.11C312.349 152.197 312.368 152.289 312.368 152.383C312.368 152.477 312.349 152.569 312.313 152.656C312.277 152.742 312.224 152.821 312.158 152.887C312.091 152.953 312.012 153.006 311.925 153.041C311.838 153.077 311.745 153.095 311.651 153.095Z" fill="currentColor" />
    ...
    <div class="mt-10 flex flex-col-reverse items-center justify-between gap-5 rounded-md bg-gradient-to-tl from-[rgba(234,241,255,0.44)] to-[rgba(234,241,255,0.96)] px-6 py-2.5 dark:from-[rgba(14,23,38,0.44)] dark:to-[#0E1726] md:flex-row lg:mt-20 xl:px-16">
        ...
        <div class="w-52 max-w-xs lg:w-full">
            <img src="<?php echo base_url('assets/images/knowledge/find-solution.svg') ?>" alt="find-solution" class="w-full object-cover rtl:rotate-y-180 dark:brightness-[2.59] dark:grayscale-[83%]" />
        </div>
    </div>
    <div class="mt-10">
        ...
        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
            <div class="space-y-5 rounded-md border border-white-light bg-white p-5 shadow-[0px_0px_2px_0px_rgba(145,158,171,0.20),0px_12px_24px_-4px_rgba(145,158,171,0.12)] dark:border-[#1B2E4B] dark:bg-black">
                <div class="max-h-56 overflow-hidden rounded-md">
                    <img src="<?php echo base_url('assets/images/knowledge/image-1.jpg') ?>" alt="..." class="w-full object-cover" />
                </div>
                <h5 class="text-xl dark:text-white">Excessive sugar is harmful</h5>
                <div class="flex">
                    <div class="me-4 overflow-hidden rounded-full bg-white-dark">
                        <img src="<?php echo base_url('assets/images/profile-1.jpeg') ?>" class="h-11 w-11 object-cover" alt="profile1" />
                    </div>
                    <div class="flex-1">
            ...
            <div class="space-y-5 rounded-md border border-white-light bg-white p-5 shadow-[0px_0px_2px_0px_rgba(145,158,171,0.20),0px_12px_24px_-4px_rgba(145,158,171,0.12)] dark:border-[#1B2E4B] dark:bg-black">
                <div class="max-h-56 overflow-hidden rounded-md">
                    <img src="<?php echo base_url('assets/images/knowledge/image-2.jpg') ?>" alt="..." class="w-full object-cover" />
                </div>
                <h5 class="text-xl dark:text-white">Creative Photography</h5>
                <div class="flex">
                    <div class="me-4 overflow-hidden rounded-full bg-white-dark">
                        <img src="<?php echo base_url('assets/images/profile-2.jpeg') ?>" class="h-11 w-11 object-cover" alt="profile1" />
                    </div>
                    <div class="flex-1">
                        <h4 class="mb-1.5 font-semibold dark:text-white">Alma Clark</h4>
                        <p>06 May</p>
            ...
            <div class="space-y-5 rounded-md border border-white-light bg-white p-5 shadow-[0px_0px_2px_0px_rgba(145,158,171,0.20),0px_12px_24px_-4px_rgba(145,158,171,0.12)] dark:border-[#1B2E4B] dark:bg-black">
                <div class="max-h-56 overflow-hidden rounded-md">
                    <img src="<?php echo base_url('assets/images/knowledge/image-3.jpg') ?>" alt="..." class="w-full object-cover" />
                </div>
                <h5 class="text-xl dark:text-white">Plan your next trip</h5>
                <div class="flex">
                    <div class="me-4 overflow-hidden rounded-full bg-white-dark">
                        <img src="<?php echo base_url('assets/images/profile-3.jpeg') ?>" class="h-11 w-11 object-cover" alt="profile1" />
                    </div>
                    <div class="flex-1">
                        <h4 class="mb-1.5 font-semibold dark:text-white">Alma Clark</h4>
                        <p>06 May</p>
            ...
            <div class="space-y-5 rounded-md border border-white-light bg-white p-5 shadow-[0px_0px_2px_0px_rgba(145,158,171,0.20),0px_12px_24px_-4px_rgba(145,158,171,0.12)] dark:border-[#1B2E4B] dark:bg-black">
                <div class="max-h-56 overflow-hidden rounded-md">
                    <img src="<?php echo base_url('assets/images/knowledge/image-4.jpg') ?>" alt="..." class="w-full object-cover" />
                </div>
                <h5 class="text-xl dark:text-white">My latest Vlog</h5>
                <div class="flex">
                    <div class="me-4 overflow-hidden rounded-full bg-white-dark">
                        <img src="<?php echo base_url('assets/images/profile-4.jpeg') ?>" class="h-11 w-11 object-cover" alt="profile1" />
                    </div>
                    <div class="flex-1">
                        <h4 class="mb-1.5 font-semibold dark:text-white">Alma Clark</h4>
                        <p>06 May</p>
            ...
            <template x-for="(item, i) in items" :key="i">
                <div class="space-y-5 rounded-md border border-white-light bg-white p-5 shadow-[0px_0px_2px_0px_rgba(145,158,171,0.20),0px_12px_24px_-4px_rgba(145,158,171,0.12)] dark:border-[#1B2E4B] dark:bg-black">
                    <div class="relative h-[340px] overflow-hidden rounded-md group">
                        ...
                        <button type="button" class="absolute left-1/2 top-1/2 grid h-[62px] w-[62px] -translate-x-1/2 -translate-y-1/2 place-content-center rounded-full text-white duration-300 group-hover:scale-110" @click="toggle">
...
<script>
    document.addEventListener("alpine:init", () => {
        Alpine.data('knowledge', () => ({
            items: [{
                    src: "<?php echo base_url('assets/images/knowledge/image-5.jpg') ?>",
                    title: 'Excessive sugar is harmful',
                },
                {
                    src: "<?php echo base_url('assets/images/knowledge/image-6.jpg') ?>",
                    title: 'Creative Photography',
                },
                {
                    src: "<?php echo base_url('assets/images/knowledge/image-7.jpg') ?>",
                    title: 'Plan your next trip',
                },
                {
                    src: "<?php echo base_url('assets/images/knowledge/image-8.jpg') ?>",
