...
<html lang="en" dir="ltr">
    ...
    <head>
        ...
        <link rel="icon" type="image/svg" href="<?php echo base_url('/favicon.svg') ?>" />
    ...
    <body x-data="main" class="antialiased relative font-nunito text-sm font-normal overflow-x-hidden"
        ...
        <?= $this->include('components/common/theme-customiser') ?>

        <div class="main-container text-black dark:text-white-dark min-h-screen" :class="[$store.app.navbar]">

            <?= $this->include('components/common/sidebar') ?>

            <div class="main-content flex flex-col min-h-screen">
                <?= $this->include('components/common/header') ?>
