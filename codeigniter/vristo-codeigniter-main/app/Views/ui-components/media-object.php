            ...
            <div class="mb-5">
                <div class="flex">
                    <div class="ltr:mr-4 rtl:ml-4">
                        <img src="<?php echo base_url('assets/images/profile-5.jpeg') ?>" alt="image" class="w-16 h-16 rounded" />
                    </div>
                    <div class="flex-1">
    ...
    &lt;/div&gt;
        ...
        <div class="panel">
            ...
            <div class="mb-5">
                <div class="flex mb-5">
                    <div class="ltr:mr-4 rtl:ml-4">
                        <img src="<?php echo base_url('assets/images/profile-5.jpeg') ?>" alt="image" class="w-14 h-14 rounded" />
                    </div>
                    <div class="flex-1">
                        <h4 class="font-semibold text-lg mb-2 text-primary">Heading</h4>
                        <p class="media-text"> Fusce condimentum cursus mauris et ornare. Mauris fermentum mi id
                    ...
                    <div class="flex-1">
                        ...
                        <ul class="flex space-x-4 rtl:space-x-reverse font-bold">
                            ...
                            <li><a href="javascript:;" class="flex items-center hover:text-primary">
                                    ...
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-3.5 h-3.5 ltr:mr-1 rtl:ml-1">
                        ...
                        <div class="flex justify-between mb-2">
                            ...
                            <div class="relative" @click.outside="open = false">
                                <a href="javascript:;" @click="toggle">
                                    ...
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 opacity-70 text-white-dark">
                                        <circle cx="5" cy="12" r="2" stroke="currentColor" stroke-width="1.5"></circle>
                                        <circle opacity="0.5" cx="12" cy="12" r="2" stroke="currentColor" stroke-width="1.5"></circle>
                                        <circle cx="19" cy="12" r="2" stroke="currentColor" stroke-width="1.5"></circle>
                                    </svg>
                                </a>
                                <ul x-cloak x-show="open" x-transition x-transition.duration.300ms class="ltr:right-0 rtl:left-0 top-full whitespace-nowrap" @click="toggle">
                                    <li><a href="javascript:;">

                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 ltr:mr-1 rtl:ml-1">
                                                <g opacity="0.5">
