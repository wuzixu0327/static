...
<div x-data="carousel">
    ...
    <div class="pt-5 space-y-8">
        <div class="panel p-3 flex items-center text-primary overflow-x-auto whitespace-nowrap">
            ...
            <span class="ltr:mr-3 rtl:ml-3">Documentation: </span><a href="https://www.npmjs.com/package/swiper" target="_blank" class="block hover:underline">https://www.npmjs.com/package/swiper</a>
        </div>
                    ...
                    <div class="swiper-wrapper">
                        <template x-for="item in items">
                            <div class="swiper-slide">
                                <img :src="`<?php echo base_url('assets/images') ?>/${item}`" class="w-full max-h-80 object-cover" alt="image" />
                            </div>
                        </template>
                    </div>
            ...
            <div class="panel">
                ...
                <div class="swiper max-w-3xl mx-auto mb-5" id="slider3">
                    <div class="swiper-wrapper">
                        <template x-for="item in items">
                            <div class="swiper-slide">
                                <img :src="`<?php echo base_url('assets/images') ?>/${item}`" class="w-full" alt="image" />
