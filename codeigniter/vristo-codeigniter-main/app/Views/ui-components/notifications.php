...
<div>
            ...
            <div class="panel lg:row-span-2">
                ...
                <div class="mb-5">
                    ...
                    <div class="flex items-center justify-center mb-10 gap-2">
                        <button type="button" class="btn btn-success" @click="showMessage('Example notification text.',$store.app.rtlClass === 'rtl' ? 'top-end' : 'top-start')">Top
                            Left</button>
                        <button type="button" class="btn btn-secondary" @click="showMessage('Example notification text','top')">Top Center</button>
                        <button type="button" class="btn btn-info" @click="showMessage('Example notification text.', $store.app.rtlClass === 'rtl' ? 'top-start' : 'top-end')">Top
                            Right</button>
                    </div>
                    <h6 class="font-semibold text-base dark:text-white-light mb-3 text-center">Bottom Position</h6>
                    <div class="flex items-center justify-center gap-2">
                        <button type="button" class="btn btn-dark" @click="showMessage('Example notification text.', $store.app.rtlClass === 'rtl' ? 'bottom-end' : 'bottom-start')">Bottom
                            Left</button>
                        <button type="button" class="btn btn-primary" @click="showMessage('Example notification text.','bottom')">Bottom Center</button>
                        <button type="button" class="btn btn-secondary" @click="showMessage('Example notification text.', $store.app.rtlClass === 'rtl' ? 'bottom-start' : 'bottom-end')">Bottom
                            Right</button>
                    </div>
                </div>
    ...
    &lt;/script&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <div class="flex items-center justify-center">
                        <button type="button" class="btn btn-success" @click="showMessage('Example notification text.', 'bottom-start',false)">No
                            Action</button>
                    </div>
                </div>
