            ...
            <div class="mb-5">
                ...
                <div class="sm:flex">
                    <div class="relative mx-auto mb-5 sm:mb-0 ltr:sm:mr-8 rtl:sm:ml-8 z-[2] before:absolute before:top-12 before:left-1/2 before:-bottom-[15px] before:-translate-x-1/2 before:border-l-2 before:border-[#ebedf2] before:w-0 before:h-auto before:-z-[1] dark:before:border-[#191e3a] before:hidden sm:before:block">
                        <img src="<?php echo base_url('assets/images/profile-16.jpeg') ?>" alt="image" class="w-12 h-12 mx-auto rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)]" />
                    </div>
                    <div class="flex-1">
                        ...
                        <div class="mt-4 sm:mt-7 mb-16">
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-white-dark ltr:mr-2.5 rtl:ml-2.5 inline-block align-text-bottom">
                            ...
                            <div class="ltr:pl-8 rtl:pr-8 flex space-x-1 rtl:space-x-reverse mt-6">
                                <img src="<?php echo base_url('assets/images/profile-16.jpeg') ?>" alt="image" class="w-10 h-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none" />
                                <img src="<?php echo base_url('assets/images/drag-1.jpeg') ?>" alt="image" class="w-10 h-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none" />
                                <img src="<?php echo base_url('assets/images/drag-2.jpeg') ?>" alt="image" class="w-10 h-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none" />
                                <img src="<?php echo base_url('assets/images/profile-16.jpeg') ?>" alt="image" class="w-10 h-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none" />
                                <img src="<?php echo base_url('assets/images/drag-4.jpg') ?>" alt="image" class="w-10 h-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="sm:flex">
                    <div class="relative mx-auto mb-5 sm:mb-0 ltr:sm:mr-8 rtl:sm:ml-8 z-[2] before:absolute before:top-12 before:left-1/2 before:-bottom-[15px] before:-translate-x-1/2 before:border-l-2 before:border-[#ebedf2] before:w-0 before:h-auto before:-z-[1] dark:before:border-[#191e3a] before:hidden sm:before:block">
                        <img src="<?php echo base_url('assets/images/profile-7.jpeg') ?>" alt="image" class="w-12 h-12 mx-auto rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)]" />
                    </div>
                    <div class="flex-1">
                        <h4 class="text-primary text-xl font-bold text-center ltr:sm:text-left rtl:sm:text-right">
                            Justin Cross</h4>
                        ...
                        <div class="mt-4 sm:mt-7 mb-16">
                            ...
                            <div class="ltr:pl-8 rtl:pr-8 grid grid-cols-3 sm:grid-cols-5 lg:grid-cols-8 gap-3 mt-6">
                                <img src="<?php echo base_url('assets/images/drag-1.jpeg') ?>" alt="image" class="w-full rounded-md shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none" />
                                <img src="<?php echo base_url('assets/images/profile-16.jpeg') ?>" alt="image" class="w-full rounded-md shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none" />
                                <img src="<?php echo base_url('assets/images/drag-4.jpg') ?>" alt="image" class="w-full rounded-md shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="sm:flex">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="mt-4 sm:mt-7 mb-16">
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4.5 h-4.5 text-white-dark ltr:mr-2.5 rtl:ml-2.5 inline-block align-text-bottom">
        ...
        &lt;div class=&quot;sm:flex&quot;&gt;
            ...
            &lt;div class=&quot;flex-1&quot;&gt;
                ...
                &lt;div class=&quot;mt-4 sm:mt-7 mb-16&quot;&gt;
                    ...
                    &lt;div class=&quot;ltr:pl-8 rtl:pr-8 grid grid-cols-3 sm:grid-cols-5 lg:grid-cols-8 gap-3 mt-6&quot;&gt;
                    &lt;img src=&quot;&#60;&#63;php echo base_url('assets/images/drag-1.jpeg') &#63;&#62;&quot; alt=&quot;image&quot; class=&quot;w-full rounded-md shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none&quot; /&gt;
                    &lt;img src=&quot;&#60;&#63;php echo base_url('assets/images/profile-16.jpeg') &#63;&#62;&quot; alt=&quot;image&quot; class=&
                ...
                <ul class="relative py-12 before:absolute before:bg-[#ebedf2] dark:before:bg-[#191e3a] before:bottom-0 before:left-1/2 before:top-0 before:w-[3px] before:-ml-[1.5px] max-w-[900px] mx-auto table">
                    <li class="relative mb-12 before:clear-both before:table after:clear-both after:table">
                        ...
                        <div class="relative border border-[#ebedf2] dark:border-[#191e3a] max-w-[320px] mx-auto sm:max-w-full w-full sm:w-[46%] shadow-[0_20px_20px_rgba(126,142,177,0.12)] rounded-md bg-white dark:bg-[#191e3a] ltr:sm:float-left rtl:sm:float-right before:absolute before:bg-[#ebedf2] dark:before:bg-[#191e3a] before:w-[37px] before:h-[3px] before:rounded-full ltr:before:-right-[37px] rtl:before:-left-[37px] before:top-10 sm:before:block before:hidden">
                            <div>
                                <img src="<?php echo base_url('assets/images/carousel1.jpeg') ?>" alt="timeline" class="w-full rounded-t-md" />
                            </div>
                            <div class="p-5">
                    ...
                    <li class="relative mb-12 before:clear-both before:table after:clear-both after:table">
                        <div class="hidden sm:block absolute bg-primary border-[3px] border-[#ebedf2] dark:border-[#191e3a] w-5 h-5 rounded-full left-1/2 top-[32px] -ml-2.5 z-[1]">
                        </div>
                        <div class="relative border border-[#ebedf2] dark:border-[#191e3a] max-w-[320px] mx-auto sm:max-w-full w-full sm:w-[46%] shadow-[0_20px_20px_rgba(126,142,177,0.12)] rounded-md bg-white dark:bg-[#191e3a] ltr:sm:float-right rtl:sm:float-left before:absolute before:bg-[#ebedf2] dark:before:bg-[#191e3a] before:w-[37px] before:h-[3px] before:rounded-full  ltr:before:-left-[37px] rtl:before:-right-[37px] before:top-10 sm:before:block before:hidden">
                            <div>
                                <img src="<?php echo base_url('assets/images/menu-heade.jpg') ?>" alt="timeline" class="w-full rounded-t-md" />
                            </div>
                            <div class="p-5">
                    ...
                    <li class="relative mb-12 before:clear-both before:table after:clear-both after:table">
                        <div class="hidden sm:block absolute bg-success border-[3px] border-[#ebedf2] dark:border-[#191e3a] w-5 h-5 rounded-full left-1/2 top-[32px] -ml-2.5 z-[1]">
                        </div>
                        <div class="relative border border-[#ebedf2] dark:border-[#191e3a] max-w-[320px] mx-auto sm:max-w-full w-full sm:w-[46%] shadow-[0_20px_20px_rgba(126,142,177,0.12)] rounded-md bg-white dark:bg-[#191e3a] ltr:sm:float-left rtl:sm:float-right before:absolute before:bg-[#ebedf2] dark:before:bg-[#191e3a] before:w-[37px] before:h-[3px] before:rounded-full ltr:before:-right-[37px] rtl:before:-left-[37px] before:top-10 sm:before:block before:hidden">
                            <div>
                                <img src="<?php echo base_url('assets/images/carousel1.jpeg') ?>" alt="timeline" class="w-full rounded-t-md" />
                    ...
                    <li class="relative mb-12 before:clear-both before:table after:clear-both after:table">
                        <div class="hidden sm:block absolute bg-danger border-[3px] border-[#ebedf2] dark:border-[#191e3a] w-5 h-5 rounded-full left-1/2 top-[32px] -ml-2.5 z-[1]">
                        </div>
                        <div class="relative border border-[#ebedf2] dark:border-[#191e3a] max-w-[320px] mx-auto sm:max-w-full w-full sm:w-[46%] shadow-[0_20px_20px_rgba(126,142,177,0.12)] rounded-md bg-white dark:bg-[#191e3a] ltr:sm:float-right rtl:sm:float-left before:absolute before:bg-[#ebedf2] dark:before:bg-[#191e3a] before:w-[37px] before:h-[3px] before:rounded-full  ltr:before:-left-[37px] rtl:before:-right-[37px] before:top-10 sm:before:block before:hidden">
                            <div>
                                <img src="<?php echo base_url('assets/images/menu-heade.jpg') ?>" alt="timeline" class="w-full rounded-t-md" />
        ...
        <div class="panel">
            ...
            <div class="mb-5">
                <div class="max-w-[900px] mx-auto">
                    <div class="flex">
                        <p class="text-[#3b3f5c] dark:text-white-light min-w-[58px] max-w-[100px] text-base font-semibold py-2.5">
                            10:00</p>
                    ...
                    <div class="flex">
                        <p class="text-[#3b3f5c] dark:text-white-light min-w-[58px] max-w-[100px] text-base font-semibold py-2.5">
                            16:00</p>
                        <div class="relative before:absolute before:left-1/2 before:-translate-x-1/2 before:top-[15px] before:w-2.5 before:h-2.5 before:border-2 before:border-info before:rounded-full">
                        </div>
                        <div class="p-2.5 self-center ltr:ml-2.5 rtl:ltr:mr-2.5 rtl:ml-2.5">
                ...
                <div class="max-w-[900px] mx-auto text-center ltr:sm:text-left rtl:sm:text-right space-y-3 sm:space-y-0">
                    <div class="sm:flex items-center">
                        ...
                        <div class="p-2.5 relative after:absolute after:left-1/2 after:-translate-x-1/2 after:top-[25px] after:-bottom-[15px] after:w-0 after:h-auto after:border-l-2 after:border-white-dark/20 after:rounded-full">
                            <img src="<?php echo base_url('assets/images/profile-16.jpeg') ?>" alt="image" class="w-11 h-11 rounded-full relative z-[1] mx-auto" />
                        </div>
                        <p class="text-white-dark text-xs font-bold self-center sm:min-w-[100px] sm:max-w-[100px] p-2.5 mt-5 sm:mt-0">
                            25 mins ago</p>
                    ...
                    <div class="sm:flex items-center">
                        ...
                        <div class="p-2.5 relative after:absolute after:left-1/2 after:-translate-x-1/2 after:top-[25px] after:-bottom-[15px] after:w-0 after:h-auto after:border-l-2 after:border-white-dark/20 after:rounded-full">
                            <img src="<?php echo base_url('assets/images/profile-1.jpeg') ?>" alt="image" class="w-11 h-11 rounded-full relative z-[1] mx-auto" />
                        </div>
                        <p class="text-white-dark text-xs font-bold self-center sm:min-w-[100px] sm:max-w-[100px] p-2.5 mt-5 sm:mt-0">
                            2 hrs ago</p>
                    ...
                    <div class="sm:flex items-center">
                        ...
                        <div class="p-2.5 relative after:absolute after:left-1/2 after:-translate-x-1/2 after:top-[25px] after:-bottom-[15px] after:w-0 after:h-auto after:border-l-2 after:border-white-dark/20 after:rounded-full">
                            <img src="<?php echo base_url('assets/images/profile-2.jpeg') ?>" alt="image" class="w-11 h-11 rounded-full relative z-[1] mx-auto" />
                        </div>
                        <p class="text-white-dark text-xs font-bold self-center sm:min-w-[100px] sm:max-w-[100px] p-2.5 mt-5 sm:mt-0">
                            4 hrs ago</p>
                    ...
                    <div class="sm:flex items-center">
                        ...
                        <div class="p-2.5 relative after:absolute after:left-1/2 after:-translate-x-1/2 after:top-[25px] after:-bottom-[15px] after:w-0 after:h-auto after:border-l-2 after:border-white-dark/20 after:rounded-full">
                            <img src="<?php echo base_url('assets/images/profile-3.jpeg') ?>" alt="image" class="w-11 h-11 rounded-full relative z-[1] mx-auto" />
                        </div>
                        <p class="text-white-dark text-xs font-bold self-center sm:min-w-[100px] sm:max-w-[100px] p-2.5 mt-5 sm:mt-0">
                            6 hrs ago</p>
                    ...
                    <div class="sm:flex items-center">
                        ...
                        <div class="p-2.5 relative">
                            <img src="<?php echo base_url('assets/images/profile-4.jpeg') ?>" alt="image" class="w-11 h-11 rounded-full relative z-[1] mx-auto" />
                        </div>
                        <p class="text-white-dark text-xs font-bold self-center sm:min-w-[100px] sm:max-w-[100px] p-2.5 mt-5 sm:mt-0">
                            9 hrs ago</p>
