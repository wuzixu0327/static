...
Route.get('/pages/contact-us-boxed', async ({ view }) => {
    return view.render('pages/contact-us-boxed')
})
Route.get('/pages/contact-us-cover', async ({ view }) => {
    return view.render('pages/contact-us-cover')
})
Route.get('/pages/faq', async ({ view }) => {
    return view.render('pages/faq')
})
Route.get('/pages/coming-soon-boxed', async ({ view }) => {
    return view.render('pages/coming-soon-boxed')
})
Route.get('/pages/coming-soon-cover', async ({ view }) => {
    return view.render('pages/coming-soon-cover')
})
