        ...
        <div class="panel">
            <div class="space-y-4 text-black-light">
                ...
                <ul class="list-decimal space-y-2 pl-5">
                    <li>
                        This project is using AdonisJS
                        <a target="_blank" class="font-semibold text-success hover:text-black" href="https://docs.adonisjs.com/guides/installation/"
                            >https://docs.adonisjs.com/guides/installation</a
                        >
                    </li>
                    <li>
                    ...
                    <li>Copy adonis folder from vristo-adonis and extract to your suitable directory or folder.</li>
                    ...
                    <li>
                        Run command <code class="text-black">node ace generate:key</code>. This command will generate. Copy that key set as APP_KEY in .env
                        file.
                    </li>

                    <li>Run command <code class="text-black">npm run dev</code> to start the server.</li>
            ...
            <ul class="text-sm">
                <li>
                    ...
                    <ul class="space-y-2 pl-8" :class="{ hidden: !treeview.includes('vristo') }">
                            ...
                            <ul class="space-y-2 pl-8" :class="{ hidden: !treeview.includes('resources') }">
                                ...
                                <li>
                                    ...
                                    <ul class="mb-4 pl-8 text-black-light" :class="{ hidden: !treeview.includes('views') }">
                                        <li>index.edge and all other app pages</li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <span class="inline-flex cursor-pointer items-center gap-2" @click="toggleTreeview('start')">
                                <span class="text-success">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        class="h-6 w-6"
                                    ...
                                    >
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                        <path d="M5 4h4l3 3h7a2 2 0 0 1 2 2v8a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-11a2 2 0 0 1 2 -2"></path>
                                        <path v-if="!treeview.includes('start')" d="M12 10l0 6"></path>
                                        <path d="M9 13l6 0"></path>
                                    </svg>
                                </span>
                                start
                            </span>
                            <ul class="mb-4 pl-8 text-black-light" :class="{ hidden: !treeview.includes('start') }">
                                <li>routes.ts - routes</li>
                            </ul>
                        </li>
                        <li>.adonisrc.json</li>
                        <li>.env.example</li>
...
&lt;!--  END MAIN CONTAINER  --&gt;</pre
        ...
        <div class="panel">
            <div class="space-y-4 text-black-light">
                ...
                <p>
                    <strong class="text-black">1. resources/js/custom.js : </strong>This is primary js file. It is necessary for the layout to work. It contains
                    the code as follows :-
                </p>
