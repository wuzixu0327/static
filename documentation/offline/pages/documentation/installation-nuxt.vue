        ...
        <div class="panel">
            <div class="space-y-4 text-black-light">
                ...
                <ul class="list-decimal space-y-2 pl-5">
                    ...
                    <ul class="space-y-2">
                        <li><strong>Note:-</strong> <code class="text-black">npm run generate</code> to generate static site for production.</li>
                    </ul>
                </ul>
            ...
            <ul class="text-sm">
                <li>
                    ...
                    <ul class="space-y-2 pl-8" :class="{ hidden: !treeview.includes('vristo') }">
                        ...
                        <li>
                            <span class="inline-flex cursor-pointer items-center gap-2" @click="toggleTreeview('plugins')">
                                <span class="text-success">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        class="h-6 w-6"
                                    ...
                                    >
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                        <path d="M5 4h4l3 3h7a2 2 0 0 1 2 2v8a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-11a2 2 0 0 1 2 -2"></path>
                                        <path v-if="!treeview.includes('plugins')" d="M12 10l0 6"></path>
                                        <path d="M9 13l6 0"></path>
                                    </svg>
                                </span>
                                plugins
                            </span>
                            <ul class="mb-4 pl-8 text-black-light" :class="{ hidden: !treeview.includes('plugins') }">
                                <li>all the packages file</li>
                            </ul>
                        </li>
...
<script lang="ts" setup>
    ...
    const treeview = ref(['vristo', 'components', 'public', 'assets']);
